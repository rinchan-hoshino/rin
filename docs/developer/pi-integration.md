...
| Rin-owned system prompt from Pi public capability data                       | `src/core/rin-lib/system-prompt-overlay.ts` | A first-ordered core extension consumes public tool/resource options; generated Pi prompt prose and private prompt fields are not inputs                     | `Rin system prompt uses Pi's public extension contract`     |

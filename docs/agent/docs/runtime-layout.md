...
- `chat-command-responses.json`: optional chat command acknowledgement copy for `/new`, `/abort`, `/compact`, and `/reload`; absent or partial files fall back to built-in English text.
...
- `~/.rin/docs/pi/...`
- `~/.rin/settings.json`
- `~/.rin/chat-command-responses.json`
- `~/.rin/auth.json`
- `~/.rin/sessions/...`
- `~/.rin/memory/...`
- `~/.rin/app/current/...`

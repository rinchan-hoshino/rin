...
| Scheduled tasks                          | Reminders, requested later execution, recurring checks, or conditional automation                                         | Rin Agent SDK `rin.tasks.*`                                | `docs/agent-sdk.md`, `docs/scheduled-tasks.md`           |

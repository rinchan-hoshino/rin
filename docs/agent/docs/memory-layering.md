...
| Self-improve | Reusable skills       | `self_improve/skills/<skill>/`                                       | A reusable workflow belongs in a discoverable skill                                         |
| Self-improve | Short-term continuity | `self_improve/skills/short-term-memory/SKILL.md` plus narrow records | Active distilled handoff state guides current work                                          |

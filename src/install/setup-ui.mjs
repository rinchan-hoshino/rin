...
export async function collectChoices({hasAgents = false, legacy = null, home, agentsPath, ui = clack} = {}) {
  ...
  note(ui,'Enables context management and memories; grants full filesystem access and sets approval_policy=never. Prevents sleep during work and keeps remote control awake while plugged in. Uses an empty Git branch prefix, squash merges and best-effort worktree refresh. Disables Sites, Hotline and Safety Settings connectors. Other settings are preserved.','Recommended Codex profile');

...
function buildRinDocsBlock(agentDir: string) {
  ...
  return [
    ...
    "- Common Rin routes: Scheduled tasks/reminders/cron jobs -> docs/scheduled-tasks.md; chat bridge -> docs/chat-bridge.md; rich chat content -> docs/chat-rich-content.md; non-interactive CLI -> docs/non-interactive-cli.md; runtime layout/update -> docs/runtime-layout.md and docs/capabilities.md.",

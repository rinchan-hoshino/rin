...
test('progress head and three sections retain exact visible separators', () => {
...
test('Telegram renderer protects code and formats native Markdown', () => {

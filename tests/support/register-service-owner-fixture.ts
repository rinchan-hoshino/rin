...
const sources: Record<string, string> = {
  ...
  "dist/core/rin-install/fs-utils.js": `
    ...
    export function captureCommandAsUser(user, command, args, env) { event("capture-user", user, command, args, env); if (globalThis.__rinServiceScenario.captureError) throw new Error("owner capture failed"); return globalThis.__rinServiceScenario.captureResult || "none"; }

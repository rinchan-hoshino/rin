...
const sources: Record<string, string> = {
  ...
  "dist/core/rin-extension-settings.js": `
    ...
    export function listRinBackgroundExtensionConfigs(settings, options) { globalThis.__rinExtensionsOwnerEvents.push(["configs", settings, options]); return globalThis.__rinExtensionsOwnerScenario.entries || []; }

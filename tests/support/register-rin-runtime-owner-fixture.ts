...
const sources: Record<string, string> = {
  ...
  `,
  "../session/fork.js": `export const EPHEMERAL_FORK_DISABLE_ROUTINE_COMPACTION_KEY = Symbol.for("rin.ephemeralForkDisableRoutineCompaction");`,
  ...
  makeSession(options: any) {
    ...
    const session: any = {
      ...
      _rebuildSystemPrompt(toolNames: string[]) {
        ...
        this._baseSystemPrompt = owner.nativePrompt;
        return owner.nativePrompt;
      },

...
try{
 ...
 await updater.startUpdater({...base,readInstalledUpdateLanguage:()=>"",releaseRequest:{channel:"stable",branch:"",version:"",explicitReleaseChannel:false},confirm:async()=>false});
 ...
 await updater.startUpdater({...base,readInstalledRelease:()=>({channel:"invalid"}),releaseRequest:{channel:"nightly",branch:"",version:"",explicitReleaseChannel:true},confirm:async()=>false});

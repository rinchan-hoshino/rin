...
const stats = await importBuiltModule<
  typeof import("../../src/core/rin-frontend-sdk/stats.js")
>("dist/core/rin-frontend-sdk/stats.js");
...
test("tui stats reject missing context windows and accept post-compaction usage", () => {
  assert.equal(stats.getContextUsage(undefined, [], []), undefined);
  ...
  assert.equal(usage?.contextWindow, 2000);

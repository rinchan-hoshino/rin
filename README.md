...
Choose and authenticate an agent, then follow the [guided installation prompt](prompts/install.md). Runtime configuration is shown in [examples/chat.json](examples/chat.json) and [examples/nerve.json](examples/nerve.json). The [persona practice prompt](prompts/persona-practice.md) is an optional separate artifact.
